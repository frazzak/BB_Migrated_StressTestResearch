...
def experiment(repeats, series, features):
    ...
    return error_scores
# execute experiment
def run(features = 1,repeats = 10, file = '/Users/phn1x/icdm2018_research_BB/Stress_Test_Research/TransferLearning_CapitalPredict/data/shampoo.csv'):
        #load dataset

...
# parser.add_argument('--modeltype', type=str, default="vae", metavar='M',
#                     help='modeltype passed'),
# parser.add_argument('--cond', type=list, default=None, metavar='T',
#                     help='number of iwae samples (default: 100)')
...
def bdmc(model, loader, forward_schedule, n_sample, modeltype = "vae", cond = None):
  ...
  if modeltype in ["mcvae", "cvae"]:
      ...
      backward_logws = ais.ais_trajectory(
            ...
            n_sample=n_sample, modeltype = modeltype, cond = cond)
  else:
    # forward chain
    forward_logws = ais.ais_trajectory(
        model,
    ...
    backward_logws = ais.ais_trajectory(
        ...
        forward=False,
        schedule=backward_schedule,
        n_sample=n_sample, modeltype = modeltype)
